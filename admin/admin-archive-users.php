...
<div class=body-content>
	<div class=navigation>
		...
		<ul>
			<li><i class="fas fa-user-circle"></i><a href="admin-users.php" >USERS </a></li>
			<li><i class="fas fa-project-diagram"></i><a href="admin-archive-users.php" class="active" >ARCHIVED USERS </a></li>
				...
				<div class=panel-nav>	
					<div class=panel-nav-holder>
						...
						<div class=search-container>
							<form action=admin-archive-users.php method=POST>
			...
			<table border=0>
				...
				if(isset($_POST['find'])){
					...
					if($search != NULL){
					   ...
					   $sqlfind = "Select * from tbl_user where UserID LIKE '%$search%' AND status='Archived' or Email LIKE 
					   '%$search%' AND status='Archived' or Type LIKE '%$search%' AND status='Archived' ";
					   
				   }else{
					   $sqlfind = "Select * from tbl_user where status='Archived'";	
				   }
				...
				while($rowfind = $resultfind->fetch_assoc()){
				  ...
				  echo "<td><a href=delete-user.php?id=".$rowfind['UserID']."> Delete </a></td>";
				  echo "<td><a href=restore-user.php?id=".$rowfind['UserID']."> Restore </a></td>";
				  echo "</tr>";
				...
				$sql = "Select * from tbl_user where Status='Archived'";	
				...
				while($row = $result->fetch_assoc()){
				  ...
				  echo "<td><a href=delete-user.php?id=".$row['UserID']."> Delete </a></td>";
				  echo "<td><a href=restore-user.php?id=".$row['UserID']."> Restore </a></td>";
				  echo "</tr>";
