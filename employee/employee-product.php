...
<div class=body-content>
	<div class=navigation>
		...
		<ul>
		<li><i class="fas fa-box-open"></i><a href="employee-product.php" class="active" >PRODUCTS </a></li>
			...
			<table border=0>
				...
				if(isset($_POST['find'])){
				   ...
				   if($rowfind['Quantity']<=5){
					 ...
					 echo "<td><img src=../manager/".$row['ProductImage'] . "></span></td>";
					 ...
					 echo "</tr>";
						   ...
						   echo "<td><img src=../manager/".$rowfind['ProductImage'] . "></td>";
				...
				if($row['Quantity']<=5){
				  ...
				  echo "</tr>";
						...
						echo "<td><img src=../manager/".$row['ProductImage'] . "></td>";
						echo "<td>" . $row['Name'] . "</td>";
