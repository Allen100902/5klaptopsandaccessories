...
<div class=body-content>
	<div class=navigation>
		...
		<ul>
		<li><i class="fas fa-box-open"></i><a href="employee-product.php" >PRODUCTS </a></li>
			...
			<table border=0>			
				...
				if(isset($_POST['find'])){
					...
					if($search != NULL){
					   ...
					   $sqlfind = "Select * from tbl_order where orderID LIKE '%$search%' or userID LIKE '%$search%' or Email LIKE '%$search%' or CustomerName LIKE '%$search%'or status LIKE '%$search%' or Method LIKE '%$search% ORDER BY DateTime Desc'";
					   
				   }else{
					   $sqlfind = "Select * from tbl_order ORDER BY DateTime Desc";	
				   }
				...
				$sql = "Select * from tbl_order ORDER BY DateTime Desc";	
