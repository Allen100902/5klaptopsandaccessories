...
<?php echo "<form action=products.php method=POST>" ?>
	<div id=navbar>
...
<div class=body>
	...
	<div class=catholder>
		...
		<button formaction='products.php' name=filter>Filter</button>	
	</div>
    ...
    <?php
		...
		if(isset($_POST['filter'])){
			...
			if($cat=="Laptops"){
				$sql2 = "SELECT * from tbl_product WHERE Category='$cat' && Status='Active'";
			}elseif($cat=="Accessories"){
				$sql2 = "SELECT * from tbl_product WHERE Category='$cat' && Status='Active'";
			}else{
			$sql2 = "SELECT * from tbl_product WHERE Status='Active'";
			}
