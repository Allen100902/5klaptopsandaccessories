...
if(array_key_exists('UID',$_SESSION) && !empty($_SESSION['UID'])){
  ...
  $hidden_password = preg_replace("|.|","*",$pw);
?>
<html>
	...
	<div id=navbar>
		<div class=navbar-container>
			...
			<div class=search-container>
				...
				<input type=submit formaction='../search.php' name=find value=Search>
</form>	
			</div>	
...
<div class=body>
    ...
    <div class=ul>
      <a href='customer.php' class=active>PROFILE</a>
    ...
    <div class=account-content>
       <h1 class=account-head> Customer Profile</h1>
    <table class=tbl>
      <tr>
        <td>Firstname:</td>
        <td><?php echo"<span> $firstname";?></span></td>       
      </tr>
      <tr>
        <td>Lastname:</td>
        <td><?php echo"<span> $lastname";?></span></td>
      </tr>
      <tr>
       <td >Email: </td>
       <td><?php echo"<span> $email";?></span></td>
      </tr>
      <td >Password: </td>
       <td><?php echo"<span> $hidden_password";?> <?php echo"<a href=edit-password.php>change</a></span>"; ?></td>

      </tr>
        <tr>
          <td colspan=2><a href='edit.php'><button>Edit</button></a></td>
        </tr>
