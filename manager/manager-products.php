	...
	<div class=	>
		...
		<div class=panel-content>
			...
			<div class=panel-nav>	
					<div class=panel-nav-holder>
						...
						<div class=search-container>
							<form action=manager-products.php method=POST>
								<input type="text" name=search placeholder="Search in Products..">	
				...
				<div class=holder>
				<a href='manager-add-product.php'><button class=add-button-holder> Add a Product </Button> </a>
				</div>
			...
			<table border=0>
				...
				if(isset($_POST['find'])){
					...
					$sqlfind = "Select * from tbl_product where ProductID LIKE '%$search%' AND Status='Active' or Name LIKE '%$search%' AND Status='Active' or Category LIKE '%$search%' AND Status='Active' ";
				   ...
				   if($rowfind['Quantity']<=5){
					 ...
					 echo "<td><img src=".$rowfind['ProductImage'] . "></span></td>";
					 ...
					 echo "<td><a href=archive-product.php?id=".$rowfind['ProductID']."> Archive </a> <br> <a href=manager-edit-product.php?id=".$rowfind['ProductID']."> Edit </a><br><a href=manager-quantity-product.php?id=".$rowfind['ProductID']."> Add </a></td>";
				...
				$sql = "Select * from tbl_product where Status='Active'";	
				...
				if($row['Quantity']<=5){
				  ...
				  echo "<td><a href=archive-product.php?id=".$row['ProductID']."> Archive </a><br><a href=manager-edit-product.php?id=".$row['ProductID']."> Edit </a><br><a href=manager-quantity-product.php?id=".$row['ProductID']."> Add </a></td>";
